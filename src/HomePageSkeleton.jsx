...
function HomePageSkeleton() {
    return (
        ...
        <div className="flex gap-1 items-center justify-between p-4 bg-gray-800 shadow-md">
          <div className="h-10 w-32 bg-gray-700 rounded-lg"></div>
          <div className="h-10 w-96 bg-gray-700 rounded-lg"></div>
          <div className="h-10 w-32 flex bg-gray-700 rounded-lg gap-1">
        ...
        <div className="flex">
          <div className="w-1/5 bg-gray-800 min-h-screen p-4 hidden md:block">
            {Array(6)
              .fill("")
              .map((_, index) => (
                <div key={index} className="h-10 mb-4 bg-gray-700 rounded-lg"></div>
              ))}
