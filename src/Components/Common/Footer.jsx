...
function Footer() {
    return (
        <footer className="bg-gray-900 border-t-8 border-gray-800 text-white py-6">
            <div className="container mx-auto px-4">
                <div className="flex flex-col  mb-8 sm:flex-row justify-between items-center">
                    <div className="mb-4 sm:mb-0">
                        ...
                        <p className="text-sm text-gray-400">© {new Date().getFullYear()} PlayTube. All rights reserved.</p>
                    </div>
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://github.com/Sanjaygehlot1" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                        ...
                        <a href="https://www.instagram.com/sanjay_.095?igsh=MTZ0Ync0NXg1cjdwcg==" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" color="currentColor" fill="none"
